...
},
{
  ...
  choices: ["HTML5", "CSS3", "JavaScript", "Node.js", "jQuery", "Markdown", "Bootstrap", "UIKit", "Jest", "VSCode", "GitHub", "Heroku", "MySQL", "inquirer", "express", "sequelize", "Insomnia", "express-session", "express-handlebars", "bcrpyt", "dotenv", "MongoDB"],
  name: 'tools',
},
{
  type: 'list',
